...
class mainWindow(wx.Frame):
	def __init__(self):
		super(mainWindow, self).__init__(None, title='Vanilla - ' + version.getVersion())
		...
		i = helpMenu.Append(-1, _("About Vanilla..."))
		self.Bind(wx.EVT_MENU, self.OnAbout, i)
		self.menubar.Append(helpMenu, _("Help"))

		#Menu de teste
		wizardMenu = wx.Menu()
		i = wizardMenu.Append(-1, _("Teste..."), 'Visite o site')
		self.Bind(wx.EVT_MENU, lambda e: webbrowser.open('http://www.triadetech.com.br/home'), i)
		self.menubar.Append(wizardMenu, _("Wizard"))
