...
class SceneView(openglGui.glGuiPanel):
	def __init__(self, parent):
		...
		#Buttons to decide which printer to use
		#self.printerButton =  openglGui.glButton(self, 20, _("3D Printer"), (0,2), self.on3dPrinterSelect)
		#elf.laserButton =  openglGui.glButton(self, 21, _("Laser"), (0,3), self.onLaserSelect)
		#self.plotterButton =  openglGui.glButton(self, 24, _("Plotter"), (0,4), self.onPlotterSelect)
		#self.fresaButton =  openglGui.glButton(self, 25, _("Fresa"), (0,5), self.onFresaSelect)
	...
	# def OnPrinterSelect(self):
	# 	return

	# def OnLaserSelect(self):
	# 	return

	# def OnPlotterSelect(self):
	# 	return

	# def OnFresaSelect(self):	
	# 	return
