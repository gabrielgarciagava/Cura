...
class aboutWindow(wx.Frame):
	def __init__(self):
		...
		title = wx.StaticText(p, -1, 'Vanilla')
		title.SetFont(wx.Font(18, wx.SWISS, wx.NORMAL, wx.BOLD))
		s.Add(title, flag=wx.ALIGN_CENTRE|wx.EXPAND|wx.BOTTOM, border=5)

		s.Add(wx.StaticText(p, -1, 'A Open Source software for generating GCode to the Versa printer.'))
		s.Add(wx.StaticText(p, -1, 'Vanilla is based on Cura source by Ultimaker, and is developed by Triadetech.'))
		...
		s.Add(wx.StaticText(p, -1, 'Vanilla is build with the following components:'), flag=wx.TOP, border=10)
		self.addComponent('Cura (A alterar quando projeto for criado no github)', 'Graphical user interface', 'AGPLv3', 'https://github.com/daid/Cura')
		self.addComponent('CuraEngine (A alterar quando projeto for criado no github)', 'GCode Generator', 'AGPLv3', 'https://github.com/Ultimaker/CuraEngine')
